...
for(rds_file in file_names){
	...
	new_path = paste0("C:\\Users\\anthony\\Desktop\\my_project\\2016_12_12\\Table_of_ChangHua\\",substr(rds_file,1,10), ".rds")
	saveRDS(eight_direct_dist_taipei, file = new_path)
}